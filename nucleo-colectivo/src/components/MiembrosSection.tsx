export default function MiembrosSection() {
  const members = [
    ...
    {
      name: 'Carlos Londoño',
      role: 'Artista plástico y realizador audiovisual',
      slug: 'carlos-londono',
      bio: 'Exploro el cuerpo, la ciudad y sus distopías a través del arte plástico y el audiovisual. Mis proyectos investigan las tensiones entre el espacio urbano, la corporalidad y las narrativas contemporáneas.',
      disciplines: ['Arte Plástico', 'Videoarte', 'Fotografía', 'Performance', 'Ensayo Visual'],
      image: '/images/artist-avatar.svg',
      featured: true,
    },
  ];
